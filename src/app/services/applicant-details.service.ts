...
export class ApplicantDetailsService {
  ...
  // updateAppliedJob(jobId: string,applied:IAppliedJob):Observable<IAppliedJob>{
  // return this.httpClient.put<IAppliedJob>(`${environment.baseUrl}/update/${jobId}`,applied);
  // }
